    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_number', models.CharField(default=0, max_length=100)),
                ('member_prefix', models.CharField(default=0, max_length=20)),
                ...
                ('certificate_of_incorporation', models.FileField(blank=True, upload_to=CRM.models.UploadFolder('documents/clients'))),
                ('copy_of_id', models.FileField(blank=True, upload_to=CRM.models.UploadFolder('documents/clients'))),
                ('copy_of_blank_cheque', models.FileField(blank=True, upload_to=CRM.models.UploadFolder('documents/clients'))),
                ('copy_of_trade_licence', models.FileField(blank=True, upload_to=CRM.models.UploadFolder('documents/clients'))),
                ('list_of_product_barcoded', models.FileField(blank=True, upload_to=CRM.models.UploadFolder('documents/clients'))),
                ('director_pin_number', models.FileField(blank=True, upload_to=CRM.models.UploadFolder('documents/clients'))),
                ('company_certificate_pin', models.FileField(blank=True, upload_to=CRM.models.UploadFolder('documents/clients'))),
                ('copy_of_kebs_certicate', models.FileField(blank=True, upload_to=CRM.models.UploadFolder('documents/clients'))),
