...
class ClientCreateView(SuccessMessageMixin, CreateView):
    fields = ('company_name', 'Prenom', 'Nom', 'Sexe', 'photo', 'Email', 'tel_f',  'tel_p', 'pays', 'Nationality', 'archive', 'Matricule', 'certificate_of_incorporation','copy_of_id', 'copy_of_blank_cheque',
